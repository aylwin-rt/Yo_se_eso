...
public class RespuestaPorUsuarioAdapter extends RecyclerView.Adapter<RespuestaPorUsuarioAdapter.RespuestaPorUsuarioAdapterViewHolder> {
    ArrayList<Respuesta> listRespuesta;
    RespuestaPorUsuarioAdapter.OnItemClickListener listener;

    public RespuestaPorUsuarioAdapter(ArrayList<Respuesta> listRespuesta) {
    ...
    @NonNull
    @Override
    public RespuestaPorUsuarioAdapter.RespuestaPorUsuarioAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_respuesta,parent,false);
        return new RespuestaPorUsuarioAdapter.RespuestaPorUsuarioAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RespuestaPorUsuarioAdapter.RespuestaPorUsuarioAdapterViewHolder holder, int position) {
...
/*
    ...
    public class RespuestaPorUsuarioAdapterViewHolder extends RecyclerView.ViewHolder {

        TextView tv_nombre, tv_fecha, tv_tema, tv_nombreUsuario;//tv_rutaImagen
        ImageView img_foto;

        public RespuestaPorUsuarioAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public void setOnItemClickListener(RespuestaPorUsuarioAdapter.OnItemClickListener listener){
